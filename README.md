...
* [aap_host_prepare.yml](aap_host_prepare.yml)
  * Example playbook to prepare RHEL systems for AAP 2.7 installation
...
* [inventory.lab](inventory.lab)
  * Example containerized inventory to install AAP 2.7 in a small lab
...
and
[obtaining a manifest file](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.7/install-assembly_aap_manifest_files).
...
[obtain a manifest file](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.7/install-assembly_aap_manifest_files),
...
sudo dnf --enablerepo=ansible-automation-platform-2.7-for-rhel-10-x86_64-rpms install \
